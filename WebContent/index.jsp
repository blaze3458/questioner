		...
		<div class="con-center">
			<div class="flex-row p-t-100 p-b-200">
				<div class="flex-col-l-m flex-2 m-l-60 m-r-20">
					...
					<div class="txt-l txt-w-l lh-2-0 text-left fadeInDown animated">Questioner çevrimiçi sýnav hizmeti sunar. Þimdi kayýt ol sýnavlar oluþtur veya öðrenci olarak sýnava gir.</div>
				</div>
					...
					<div class="lg-form-c">
						<div class="form-pad">
							<form class="p-t-20 lg-form" method="POST" action="/login">
								...
								<div class="form-i-con">
									<input class="inp" name="password" type="password" placeholder="Þifre">
								</div>
								<div class="form-i-con">
									<button class="btn btn-b btn-blue" type="submit">Giriþ Yap</button>
								</div>
								<div class="form-i-con">
									<a class="" href="/forget_password.jsp">Þifreni mi unuttun?</a>
								</div>
							</form>
						</div>
						<hr/>
						<div class="form-marg flex-c">
							<button id="signUpForm" class="btn btn-b btn-green">Yeni Hesap Oluþtur</button>
						</div>
					</div>
				</div>
			</div>
		...
		<div class="fix-w-form">
			<div class="reg-form zoomOut animated">
				...
				<form class="p-t-20 p-b-20 lg-form" id="registerForm" method="POST" action="">
					<div class="form-i-con">
						<input class="inp" name="name" type="text" placeholder="Adýn" required>
					</div>
					<div class="form-i-con">
						<input class="inp" name="surname" type="text" placeholder="Soyadýn" required>
					</div>
					<div class="form-i-con">
						<input class="inp" name="email" type="email" placeholder="E-posta" required>
					</div>
					<div class="form-i-con">
						<input class="inp" name="password" type="password" placeholder="Þifre" required>
					</div>
					<div class="form-i-con flex-col">
						<select class="inp" name="type">
							<option value="stu" selected>Öðrenci</option>
							<option value="tea">Öðretmen</option>
						</select>
					</div>
					<div class="form-i-con flex-col">
					...
					<div class="form-i-con">
						 ...
						 <div class="m-l-10">Sözleþmeyi kabul ediyorum.</div>
					</div>
					<div class="form-i-con">
